...
def predict():
    ...
    elif (human_string == 'bromhexine'):
        text01='ชื่อยา :Bromhexine [hydrochloride]'
        text02='ขนาด :8 mg'
        text03='ค่าความถูกต้อง :'+ str(score) + '%'
        print(image_path)
        return render_template('front.html', text1= text01, text2=text02, text3= text03, filename= image_path)
    elif (human_string == 'chlorpheniramine'):
        text01='ชื่อยา :Chlorpheniramine maleate'
        text02='ขนาด :4 mg'
        text03='ค่าความถูกต้อง :'+ str(score) + '%'
        print(image_path)
        return render_template('front.html', text1= text01, text2=text02, text3= text03, filename= image_path)
    elif (human_string == 'hydroxyzine'):
        text01='ชื่อยา :Hydroxyzine-fc'
        text02='ขนาด :10 mg'
        text03='ค่าความถูกต้อง :'+ str(score) + '%'
        return render_template('front.html', text1= text01, text2=text02, text3= text03, filename= image_path)
    elif (human_string == 'para'):
        text01='ชื่อยา :Paracetamol'
        text02='ขนาด :500 mg'
        text03='ค่าความถูกต้อง :'+ str(score) + '%'
        return render_template('front.html', text1= text01, text2=text02, text3= text03, filename= image_path)
    elif (human_string == 'other'):
        text01='ชื่อยา :ยาชนิดอื่นๆ'
        text02='ขนาด :'
        text03='ค่าความถูกต้อง :'+ str(score) + '%'
        return render_template('front.html', text1= text01, text2=text02, text3= text03, filename= image_path)
